...
var CreditCardSchema = new Entity.SchemaObject({
    ...
    id: { type: Number },
    first_name: { type: String, toObject: 'changed' },
    last_name: { type: String, toObject: 'changed' },
    full_number: { type: String, toObject: 'changed' },
    masked_card_number: { type: String },
    expiration_month: { type: Number, toObject: 'changed' },
    expiration_year: { type: Number, toObject: 'changed' },
    cvv: { type: String, toObject: 'changed' },
