...
var ProductFamilyComponentSchema = new Entity.SchemaObject({
    ...
    unit_name: { type: String, toObject: 'hasValue' },
    unit_price: { type: Number, toObject: 'hasValue' },
    pricing_scheme: { type: String, toObject: 'hasValue' },
    prices: { type: Array, arrayType: PriceSchema, toObject: 'hasValue'},
    kind: { type: String, toObject: 'hasValue' },
    archived: { type: Boolean, toObject: 'hasValue' },
    taxable: { type: Boolean, toObject: 'hasValue' }
})
